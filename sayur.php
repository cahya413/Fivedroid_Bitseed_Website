...
<body>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="fs-5 fw-bold text-primary">Sayur</p>
                <h1 class="display-5 mb-5">Silahkan Pilih Sayur Yang Ingin Anda Tanam</h1>
            </div>
            <div class="row g-4">
            <?php
    ...
    $sql = "SELECT id_tanaman, nama, kategori, deskripsi, persiapan, penanaman, perawatan, gambar FROM tbltanaman WHERE kategori = 'Sayur'";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '            <a class="btn btn-sm" href="sayur_detail.php?id=' . $id_tanaman . '"><i class="fa fa-plus text-primary me-2"></i>Lebih Lanjut</a>';
            echo '        </div>';
            echo '    </div>';
            echo '</div>';
        }

...
<!-- Navbar End -->
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Tanam</h1>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="fs-5 fw-bold text-primary">Mari Tanam</p>
                <h1 class="display-5 mb-5">Beberapa Cara Menanam Yang Kami Siapkan</h1>
            </div>
            <div class="row wow fadeInUp" data-wow-delay="0.3s">
                <div class="col-12 text-center">
                    <ul class="list-inline rounded mb-5" id="portfolio-flters">
                        <li class="mx-2 active" ><a href="tanam.html">All</a> </li>
                        <li class="mx-2"><a href="favorite.php">Favorite</a></li>
                    </ul>
                </div>
            </div>
            <div class="row g-4 portfolio-container">
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.1s">
                    <div class="portfolio-inner rounded">
                        <img class="img-fluid" src="img/dah.jpg" alt="">
                        <div class="portfolio-text">
                            <h4 class="text-white mb-4">Tanaman Hias</h4>
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="hias.php"><i class="fas fa-arrow-right"></i></a>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.3s">
                    <div class="portfolio-inner rounded">
                        <img class="img-fluid" src="img/bubuh.jpg" alt="">
                        <div class="portfolio-text">
                            <h4 class="text-white mb-4">Buah</h4>
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="buah.php"><i class="fas fa-arrow-right"></i></a>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.5s">
                    <div class="portfolio-inner rounded">
                        <img class="img-fluid" src="img/yuyur.jpg" alt="">
                        <div class="portfolio-text">
                            <h4 class="text-white mb-4">Sayur</h4>
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="sayur.php"><i class="fas fa-arrow-right"></i></a>

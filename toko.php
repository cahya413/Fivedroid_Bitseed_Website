...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Toko</h1>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="fs-5 fw-bold text-primary">Toko</p>
                <h1 class="display-5 mb-5">Berikut Merupakan Rekomendasi Toko Toko Tanaman</h1>
            </div>
            <div class="row g-4">
            <?php
    ...
    $dbname = "id21578052_bitseed"; // Ganti dengan nama database Anda
                ...
                // Query untuk mengambil data dari tabel toko
                $sql = "SELECT id_toko, nama_toko, gambar_toko FROM tbltoko";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $gambar_toko = base64_encode($row['gambar_toko']);
                        ...
                        echo '<img class="img-fluid" src="data:image/jpeg;base64,' . $gambar_toko . '" alt="' . $nama_toko . '">';
                        echo '</div>';
                        echo '<div class="service-text rounded p-5">';
                        echo '<h4 class="mb-3">' . $nama_toko . '</h4>';
                        echo '<p class="mb-4"></p>';
                        echo '<a class="btn btn-sm" href="detail_toko.php?id=' . $id_toko . '"><i class="fa fa-plus text-primary me-2"></i>Lebih Lanjut</a>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                    }
                } else {
                    echo "Tidak ada data toko yang ditemukan.";
                }

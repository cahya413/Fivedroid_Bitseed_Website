...
$username = "capri"; // Ganti dengan username database Anda
$password = "dika1234"; // Ganti dengan password database Anda
$dbname = "produk"; // Ganti dengan nama database Anda
...
if (isset($_SESSION['user_identifier'])) {
    ...
    $sql = "SELECT t.nama AS nama_tanaman, t.perawatan FROM tblkoleksi k

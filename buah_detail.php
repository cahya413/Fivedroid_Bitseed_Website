...
<!-- Navbar End -->
    ...
    $tanaman_id = isset($_GET['id']) ? $_GET['id'] : 0; // Ganti dengan parameter yang sesuai dari URL
    $sql = "SELECT id_tanaman, nama, deskripsi, persiapan, penanaman, perawatan FROM tbltanaman WHERE id_tanaman = $tanaman_id";
    $result = $conn->query($sql);
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<h1 class="mb-4">' . $nama_tanaman . '</h1>';
        echo '<p class="mb-4">' . $deskripsi . '</p>';
        
        echo '<h1 class="mb-4">Persiapan ' . $nama_tanaman . '</h1>';
        echo '<p>' . $persiapan . '</p>';
        
        echo '<h1 class="mb-4">Penanaman ' . $nama_tanaman . '</h1>';
        echo '<p class="mb-4">' . $penanaman . '</p>';
        
        echo '<h1 class="mb-4">Perawatan ' . $nama_tanaman . '</h1>';
        echo '<p class="mb-4">' . $perawatan . '</p>';
        if (isset($_SESSION['user_identifier'])) {
          echo '<a class="btn btn-sm btn-success" href="tambah_ke_koleksi.php?id=' . $tanaman_id . '"><i class="fa fa-plus text-light me-2"></i>Tambah Ke Koleksi</a>';
      }
    } else {
            ...
            <div class="row g-5">
              <div class="col-12 col-sm-6 col-lg-12">
                <div class="border-start ps-4">
                  ...
                  <h4 class="mb-3">Cari tempat beli bibit</h4>
                  <span
                    ><a href="toko.php">Cari toko disni.</a></span
                  >
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-12">

...
if (isset($_GET['nama_toko'])) {
    ...
    // Query untuk mengambil data berdasarkan id_toko
    $sql = "SELECT * FROM tbltoko WHERE nama_toko = ?";
    ...
    if ($stmt->execute()) {
        ...
        // Tampilkan formulir edit dengan data yang ada di database
        ?>
            <!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div id="layout-wrapper">
      ...
      <div class="main-content">
        <div class="page-content">
          ...
          <form class="row g-3" method="post" action="proses_edit_toko.php" enctype="multipart/form-data" accept=".jpeg, .jpg, .png, .heic">
            <div class="col-md-6">
                <label for="inputToko" class="form-label">Nama Toko</label>
                <input type="text" class="form-control" id="inputToko" name="inputToko" value="<?php echo $data['nama_toko']; ?>">
            </div>
            <div class="col-md-6">
                <label for="inputNomortelp" class="form-label">Nomor HP Toko</label>
                <input type="text" class="form-control" id="inputNomortelp" name="inputNomortelp" value="<?php echo $data['telp_toko']; ?>">
            </div>
            <div class="col-12">
                <label for="inputLokasi" class="form-label">Lokasi toko</label>
                <textarea class="form-control" id="inputLokasi" placeholder="Link lokasi" name="inputLokasi"><?php echo $data['lokasi_toko']; ?></textarea>
            </div>
            <div class="col-12">
                <label for="InputGambartoko" class="form-label">Gambar toko</label>
                <input type="file" name="InputGambartoko" id="InputGambartoko">
            </div>

      ...
      <div class="main-content">
        <div class="page-content">
          <div class="container-fluid">
            <form class="row g-3" method="post" action="proses_tambah_toko.php" enctype="multipart/form-data" accept=".jpeg, .jpg, .png, .heic">
                <div class="col-md-6">
                  <label for="inputEmail4" class="form-label">Nama Toko</label>
                  <input type="text" class="form-control" id="inputToko" name="inputToko">
                </div>
                <div class="col-md-6">
                  <label for="inputEmail4" class="form-label">Nomor HP Toko</label>
                  <input type="text" class="form-control" id="inputNomortelp" name="inputNomortelp">
                </div>
                <div class="col-12">
                  <label for="inputAddress" class="form-label">Lokasi toko</label>
                  <textarea type="text" class="form-control" id="inputLokasi" placeholder="Link lokasi" name="inputLokasi"></textarea>
                </div>
                <div class="col-12">
                  <label for="inputAddress2" class="form-label">Gambar toko</label>
                  <input type="file" name="InputGambartoko" id="InputGambartoko" required>
                </div>
                <div class="col-12">
                  <a href="toko.php"><button type="submit" class="btn btn-primary">Simpan</button></a>
                  <a href="toko.php"><button type="submit" class="btn btn-primary">Kembali</button></a>
                </div>
              </form>
            <!-- end row -->
          </div>

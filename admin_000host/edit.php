...
// Menerima parameter nama tanaman dari URL
if(isset($_GET['nama'])) {
    $nama_tanaman = $_GET['nama'];
    
    // Query ke database untuk mengambil data berdasarkan nama tanaman
    $sql = "SELECT * FROM tbltanaman WHERE nama = '$nama_tanaman'";
    $result = $conn->query($sql);

    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            // Menampilkan data ke dalam formulir di edit.php
?>
            <!DOCTYPE html>
<html lang="en">
  <head>
        ...
        <div class="page-content">
          <div class="container-fluid">
            <form class="row g-3" method="post" action="proses_edit.php">
                <div class="col-md-6">
                  <label for="inputEmail4" class="form-label">Nama tanaman</label>
                  <input type="text" class="form-control" id="inputBuah" name="inputBuah" value="<?php echo $row['nama']; ?>">
                </div>
                <div class="col-md-6">
                  <label for="inputEmail4" class="form-label">Kategori</label>
                  <input type="text" class="form-control" id="inputKategori" name="inputKategori" value="<?php echo $row['kategori']; ?>">
                </div>
                <div class="col-12">
                  <label for="inputAddress" class="form-label">Deskripsi</label>
                  <textarea type="text" class="form-control" id="inputDeskripsi" rows="7" placeholder="Deskripsi" name="inputDeskripsi"><?php echo $row['deskripsi']; ?></textarea>
                </div>
                <div class="col-12">
                  <label for="inputAddress2" class="form-label">Persiapan Bibit</label>
                  <textarea type="text" class="form-control" id="inputPersiapanbibit" rows="7" placeholder="Persiapan" name="inputPersiapanbibit"><?php echo $row['persiapan']; ?></textarea>
                </div>
                <div class="col-12">
                    <label for="inputAddress2" class="form-label">Penanaman</label>
                    <textarea type="text" class="form-control" id="inputPenanaman" rows="7" placeholder="Penanaman" name="inputPenanaman"><?php echo $row['penanaman']; ?></textarea>
                </div>
                <div class="col-12">
                    <label for="inputAddress2" class="form-label">Perawatan</label>
                    <textarea type="text" class="form-control" id="inputPerawatan" rows="7" placeholder="Perawatan" name="inputPerawatan"><?php echo $row['perawatan']; ?></textarea>
                </div>
                <div class="col-12">
                  <a href="index.php"><button type="submit" class="btn btn-primary">Simpan</button></a>
                  <button type="button" class="btn btn-danger" onclick="window.location.href='index.php';">Kembali</button>
                </div>
              </form>
            <!-- end row -->
          </div>
...
<?php
    ...
    echo "Nama tanaman tidak ditemukan";
}

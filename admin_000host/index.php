      ...
      <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                <div class="row g-4">
                    <div class="col-12">
                        <a href="tambah_tanaman.php"><button type="submit" class="btn btn-primary">Tambah</button></a>
                    </div>
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-dark">
                                            <li><a class="dropdown-item" href="#" onclick="loadData('Buah')">Buah</a></li>
                                            <li><a class="dropdown-item" href="#" onclick="loadData('Sayur')">Sayur</a></li>
                                            <li><a class="dropdown-item" href="#" onclick="loadData('Tanaman Hias')">Tanaman Hias</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div id="dataContainer" class="row g-4">
                        <?php
    ...
    $dbname = "id21578052_bitseed"; // Ganti dengan nama database Anda
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ?>
                                <div class="col-md-6 col-xl-3 column-card">
                                    <div class="card text-center">
                                        <div class="mb-2 card-body text-muted">
                                            <h3 class="text-info mt-2"><?= $row["nama"] ?></h3>
                                            <a class="btn btn-sm" href="edit.php?nama=<?= urlencode($row['nama']) ?>"><i class="fa fa-plus text-primary me-2"></i>Edit</a>
                                            <a class="btn btn-sm" href="hapus.php?nama=<?= urlencode($row['nama']) ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?')"><i class="fa fa-trash text-danger me-2"></i>Hapus</a>
                                        </div>
                                    </div>
                                </div>
                                <?php

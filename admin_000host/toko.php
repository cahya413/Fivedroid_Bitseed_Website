...
<html lang="en">
  ...
  <body data-sidebar="dark">
      ...
      <div class="main-content">
        <div class="page-content">
          <div class="container-fluid">
            <div class="row g-4">
              <div class="col-12">
                <a href="tambah_toko.php"><button type="submit" class="btn btn-primary">Tambah</button></a>
              </div>
    ...
    $dbname = "id21578052_bitseed"; // Ganti dengan nama database Anda
                    ...
                    $sql = "SELECT nama_toko, id_toko FROM tbltoko";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo '<h3 class="text-info mt-2">' . $row["nama_toko"] . '</h3>';
                            // Perbaikan pada baris di bawah ini
                            echo '<a class="btn btn-sm" href="edit_toko.php?nama_toko=' . urlencode($row['nama_toko']) . '"><i class="fa fa-pen text-primary me-2"></i>Edit</a>';
                            echo '<a class="btn btn-sm" href="tambah_produk.php?id_toko=' . urlencode($row['id_toko']) . '"><i class="fa fa-plus text-primary me-2"></i>Produk</a>';
                            echo '<a class="btn btn-sm" href="hapus_toko.php?nama_toko=' . urlencode($row['nama_toko']) . '" onclick="return confirm(\'Anda yakin ingin menghapus data ini?\')"><i class="fa fa-trash text-danger me-2"></i>Hapus</a>';
                            echo '</div></div></div>';
                        }
                    } else {
                        echo "0 results";

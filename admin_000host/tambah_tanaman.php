      ...
      <div class="main-content">
        <div class="page-content">
          <div class="container-fluid">
            <form class="row g-3" method="post" action="tambah.php" enctype="multipart/form-data" accept=".jpeg, .jpg, .png, .heic">
                <div class="col-md-6">
                  <label for="inputEmail4" class="form-label">Nama tanaman</label>
                  <input type="text" class="form-control" id="inputBuah" name="inputBuah">
                </div>
                <div class="col-md-6">
                  <label for="inputEmail4" class="form-label">Kategori</label>
                  <input type="text" class="form-control" id="inputKategori" name="inputKategori">
                </div>
                <div class="col-12">
                  <label for="inputAddress" class="form-label">Deskripsi</label>
                  <textarea type="text" class="form-control" id="inputDeskripsi" rows="7" placeholder="Deskripsi" name="inputDeskripsi"></textarea>
                </div>
                <div class="col-12">
                  <label for="inputAddress2" class="form-label">Persiapan Bibit</label>
                  <textarea type="text" class="form-control" id="inputPersiapanbibit" rows="7" placeholder="Persiapan" name="inputPersiapanbibit"></textarea>
                </div>
                <div class="col-12">
                    <label for="inputAddress2" class="form-label">Penanaman</label>
                    <textarea type="text" class="form-control" id="inputPenanaman" rows="7" placeholder="Penanaman" name="inputPenanaman"></textarea>
                </div>
                <div class="col-12">
                    <label for="inputAddress2" class="form-label">Perawatan</label>
                    <textarea type="text" class="form-control" id="inputPerawatan" rows="7" placeholder="Perawatan" name="inputPerawatan"></textarea>
                </div>
                <div class="col-12">
                  <label for="inputAddress2" class="form-label">Gambar toko</label>
                  <input type="file" name="InputGambar" id="InputGambar" required>
                </div>
                <div class="col-12">
